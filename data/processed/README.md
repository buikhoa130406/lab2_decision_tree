...
File này là output trung gian, không phải dataset raw dùng để đối chiếu checksum. Nội dung có thể được tạo lại từ `data/raw/bank-full.csv` bằng pipeline hiện tại.
